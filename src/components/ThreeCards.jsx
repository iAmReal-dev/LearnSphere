...
const ThreeCards = ({ data }) => {
    ...
    return (
        <div className="w-full  cursor-pointer">
            ...
            <div
                className=" flex flex-col lg:flex-row gap-5 rounded-2xl bg-white p-3 border transition-all duration-300 ease-in-out
          transform border-[#E4E4E4] hover:border-1 hover:border-blue-500  hover:shadow-[0_12px_40px_8px_rgba(59,130,246,0.18)]"
            >
                {/* image */}
                <img
                    className=" lg:max-w-[150px] object-cover rounded-3xl"
                    src={image}
