...
<div className="flex gap-10">
      ...
      <div
        ...
        } md:flex flex-col md:flex-row items-center gap-4 md:gap-10 absolute md:static top-14 left-0 w-[100vw] md:w-auto bg-white md:bg-transparent shadow-md md:shadow-none p-4 md:p-0 z-50 transition-transform duration-300 ease-in-out transform ${isMenuOpen ? 'translate-x-0 h-[100vh]' : '-translate-x-full md:translate-x-0'}`}
      >
